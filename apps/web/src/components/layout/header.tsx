      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-8 lg:px-12">
        ...
        <Link href="/" className="flex items-center gap-2">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-primary-container">
            <span className="font-display text-lg font-bold text-on-primary">AF</span>
          </div>
        ...
        <div className="hidden items-center gap-3 lg:flex">
          <a
            href="https://wa.me/16046185783"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 font-body text-sm font-medium text-on-surface-variant transition-colors hover:text-green-600"
          ...
          >
            ...
            <span className="hidden xl:inline">(604) 618-5783</span>
          </a>
          <Link href="/contact">
